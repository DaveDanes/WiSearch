  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-20">
        <h1 className="text-4xl md:text-6xl font-bold text-zinc-900 dark:text-white mb-6 tracking-tight leading-tight">
          We built a search engine that <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-purple-600 dark:from-orange-400 dark:to-purple-600">
      ...
      <div className="mb-24 max-w-3xl mx-auto text-center">
        <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">Who We Are</h2>
        ...
        <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed mt-4">
          This project is our capstone — our most serious, most ambitious academic work yet. It is supervised by <span className="text-zinc-900 dark:text-white font-medium">Dr. Meena Chaudhary</span>, whose guidance has helped us think not just as students, but as engineers solving a real problem.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-24 items-center">
        <div>
          <h2 className="text-3xl font-bold text-zinc-900 dark:text-white mb-6">What We Built & Why It Exists</h2>
          <p className="text-zinc-600 dark:text-zinc-400 mb-4 leading-relaxed">
            Search is broken in a very specific way. You type a perfectly reasonable question, and the engine returns nothing useful — not because the answer doesn't exist, but because your words didn't match the document's words exactly. That's the <span className="text-orange-600 dark:text-orange-400 font-medium">vocabulary mismatch problem</span>, and it's been quietly failing people for decades.
          </p>
          <p className="text-zinc-600 dark:text-zinc-400 mb-4 leading-relaxed">
            We built an <span className="text-zinc-900 dark:text-white font-medium">Intelligent Semantic Search Engine</span> that solves exactly this.
          </p>
        ...
        <div className="glass-card p-8 rounded-3xl border border-black/10 dark:border-white/10 relative overflow-hidden">
           <div className="absolute top-0 right-0 w-64 h-64 bg-purple-500/10 rounded-full blur-3xl -mr-16 -mt-16"></div>
           <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-4">Focus Areas</h3>
      ...
      {/* What We Offer */}
      <div className="mb-24">
        <h2 className="text-3xl font-bold text-zinc-900 dark:text-white mb-10 text-center">What We Offer</h2>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="glass-card p-8 rounded-3xl border border-black/10 dark:border-white/10 hover:border-orange-500/30 transition-colors">
            <div className="w-12 h-12 bg-black/5 dark:bg-white/5 rounded-xl flex items-center justify-center mb-6">
              <Search className="w-6 h-6 text-red-500 dark:text-red-400" />
            </div>
            <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-4">The Problem</h3>
          ...
          <div className="glass-card p-8 rounded-3xl border border-black/10 dark:border-white/10 hover:border-purple-500/30 transition-colors">
            <div className="w-12 h-12 bg-black/5 dark:bg-white/5 rounded-xl flex items-center justify-center mb-6">
              <Brain className="w-6 h-6 text-purple-500 dark:text-purple-400" />
            </div>
            <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-4">Our Solution</h3>
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm">
          ...
          <div className="glass-card p-8 rounded-3xl border border-black/10 dark:border-white/10 hover:border-teal-500/30 transition-colors">
            <div className="w-12 h-12 bg-black/5 dark:bg-white/5 rounded-xl flex items-center justify-center mb-6">
              <Zap className="w-6 h-6 text-teal-500 dark:text-teal-400" />
            </div>
            <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-4">The Result</h3>
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm">
      ...
      {/* Our Mission */}
      <div className="mb-24">
        <div className="glass-card p-10 rounded-3xl border border-black/10 dark:border-white/10 text-center relative overflow-hidden">
          ...
          <p className="text-xl text-zinc-700 dark:text-zinc-300 max-w-3xl mx-auto leading-relaxed">
      ...
      {/* What We Stand For */}
      <div className="mb-24">
        <h2 className="text-3xl font-bold text-zinc-900 dark:text-white mb-10 text-center">What We Stand For</h2>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="glass p-6 rounded-2xl border border-black/5 dark:border-white/5">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-zinc-900 dark:text-white">Clarity over complexity</h3>
            </div>
          ...
          <div className="glass p-6 rounded-2xl border border-black/5 dark:border-white/5">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-zinc-900 dark:text-white">Honesty about limitations</h3>
            </div>
            <p className="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed">
          ...
          <div className="glass p-6 rounded-2xl border border-black/5 dark:border-white/5">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-zinc-900 dark:text-white">Learning in public</h3>
            </div>
            <p className="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed">
      ...
      {/* Meet the Team */}
      <div className="mb-24">
        <h2 className="text-3xl font-bold text-zinc-900 dark:text-white mb-10 text-center">Meet the Team</h2>
        
        {/* Supervisor */}
        <div className="max-w-md mx-auto mb-16">
          <div className="glass-card p-6 rounded-3xl border border-black/10 dark:border-white/10 text-center relative overflow-hidden">
            ...
            <h3 className="text-xl font-bold text-zinc-900 dark:text-white">Dr. Meena Chaudhary</h3>
            <p className="text-purple-600 dark:text-purple-400 text-sm font-medium mb-4">Project Supervisor</p>
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="glass-card p-6 rounded-2xl border border-black/10 dark:border-white/10 text-center hover:border-orange-500/30 transition-colors group">
              <div className="w-16 h-16 mx-auto bg-black/5 dark:bg-white/5 rounded-full mb-4 flex items-center justify-center group-hover:bg-orange-500/10 transition-colors">
                <User className="w-6 h-6 text-zinc-500 dark:text-zinc-400 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors" />
              </div>
      ...
      <div className="mb-24 text-center max-w-3xl mx-auto">
        <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">A Note on Where We're Headed</h2>
      ...
      {/* Footer */}
      <div className="text-center border-t border-black/10 dark:border-white/10 pt-12">
        <p className="text-zinc-500 text-sm mb-2">B.Tech Capstone Project · Computer Science & Engineering</p>
        <p className="text-zinc-400 dark:text-zinc-600 text-xs">Submitted under the supervision of Dr. Meena Chaudhary</p>
      </div>
